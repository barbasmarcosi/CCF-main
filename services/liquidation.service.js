  ...
  async report(id) {
    ...
    <html>
       <head>
        ...
        </svg><h1 style="padding-left: 14rem;">Informe de liquidación</h4>
          </div>
          <div style="font-weight: bold; display: -webkit-box;">
            <div style="border: 1px solid black; padding: 0.5rem; width: 48%;">
              <p>Nombre completo: ${report.person.lastName} ${report.person.name}</p>
              <p>CUIT: ${report.person.cuit.slice(0,2)}-${report.person.cuit.slice(2,10)}-${report.person.cuit.slice(10, 12)}</p>
              <p>Fecha de liquidación: ${new Date(report.createdAt).toLocaleString()}</p>
            </div>
            <div style="border: 1px solid black; padding: 0.5rem; margin-left= -2px; width: 48%;">
            ...
            <table style="border-collapse: collapse; border: 1px solid black; text-align: center; margin-top: 2rem">
              ...
              <tbody>
                ...
                <tr style="border: 1px solid black; text-align: center; font-size: 16px;">
                  ...
                  <td></td>
                  <td></td>
                  <td>$${(report.monthAmount - report.retainedAmount).toFixed(2)}</td>
                </tr>
              </tbody>
            </table>
        </body>
